...
public class Clique_Tester {
	...
	public static boolean Debug = true; //debug flag for verbose output
	public static int MAX_CLIQUE = 100000;
	public static boolean Convert = true;
	
	//
	public static String path = "C:/Users/simon/git/Clique-Finding-Algorithm/";
	//
	
	public static String[] default_args = {path+"data/test1_200.csv", "0.75","5","8"};
	//public static String[] default_args = {"data/test1.csv", "0.9","5","8"};
	//public static String[] default_args = {"data/test1.csv", "0.85","6","10"};
	//public static String[] default_args = {path+"data/test1.csv", "0.8","15","20"};
