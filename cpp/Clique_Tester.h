...
public:
	...
	static double TH;
	static std::wstring in_file;
	static std::wstring out_file;
	static bool Debug;
	...
	static std::wstring default_args[4];

	static void main(std::wstring args[]); // test1.csv_DG.txt  0.8 5 7
	static void help();
	static void parse(std::wstring a[]);
};
